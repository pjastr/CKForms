#############################################################################
##  
##  PackageInfo.g for the package `CKForms'                     
##   
...
SourceRepository := rec(
    Type := "git",
    URL :=  "https://github.com/pjastr/CKForms",
),
...
AbstractHTML := 
  "The <span class=\"pkgname\">CKForms</span> package \
   is used for computitation for compact Clifford-Klein forms",
